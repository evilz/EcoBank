...
public class CreatePhysicalCardUseCase(ICardRepository cardRepository, UserContext userContext)
{
    public Task<Card> ExecuteAsync(CancellationToken ct = default)
    {
        ...
        return cardRepository.CreatePhysicalCardAsync(holderRef, ct);
    }
}
